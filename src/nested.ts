...
export function toCSV(questions: Question[]): string {
    ...
    stringQuestions.splice(0, 0, "id,name,options,points,published");
    const csv = stringQuestions.join("\n");
    return csv;
}
...
export function duplicateQuestionInArray(
    ...
    const copyQuestion = duplicateQuestion(newId, newQuestions[targetIndex]);
    newQuestions.splice(targetIndex + 1, 0, copyQuestion);
    return newQuestions;
}
